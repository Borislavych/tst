        ...
        todos.map((todo, index) => (
          <div key={index} className="bg-gray-100 w-full rounded-sm shadow-md p-5 my-2 transition-all duration-100 hover:shadow-lg">
            ...
            <div className="flex flex-row items-center justify-center mt-2">
              <Link to={`edit-todo/?id=${todo.id}`} className="bg-blue-500 text-white text-center rounded-sm shadow-md w-full my-2 py-2 mr-2 transition-all duration-100 hover:bg-blue-600">
                Edit
              </Link>
